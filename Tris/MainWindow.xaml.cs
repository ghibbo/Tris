...
namespace Tris
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// <summary>
        /// Start a new gameand clears all values back to the start
        /// </summary>
        private void NewGame()
        {
            ...
            //Interate very button on the Grid ....
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            mResults[index] = mPlaye1Turn ? MarkType.Cross : MarkType.Nought;

            // Set button text to the result
            button.Content = mPlaye1Turn ? "X" : "O";
